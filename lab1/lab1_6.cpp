...
// Định nghĩa (khai báo) kiểu dữ liệu cấu trúc để quản lý sinh viên gồm các thành phần là Mã số Sinh viên (kiểu chuỗi), Họ và Tên (kiểu chuỗi), 
// Năm sinh (kiểu chuỗi), Giới tính (kiểu ký tự), Điểm toán (kiểu số thực), Điểm lý (kiểu số thực), Điểm hóa (kiểu số thực), Điểm Trung bình (kiểu số thực). 
// Viết Chương trình nhập và xuất (theo thứ tự giảm dần của MASV) danh sách gồm n (0 < n ≤ 100) sinh viên.
...
// Dòng thứ 3: Chuỗi Ngày tháng năm sinh
...
// OUTPUT
// Hiển thị n sinh viên trong mảng trên n dòng liên tiếp (Đã được sắp theo thứ tự MASV giảm dần). 
// Mỗi dòng hiển thị 8 thông tin theo thứ tự sau:
...
// Điểm trung bình hiển thị hai số lẻ sau dấu thập phân (nếu có). Gợi ý dùng precision.
...
// 07520045	Nguyen Thi Lan	27/05/1989	F	10	9	8
