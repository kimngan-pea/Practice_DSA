// Define a Student structured datatype which contains: Student ID (string), Student Name (string),  BirthYear (string), Gender (Char), 
// and student marks including Math (float), Physics (float), Chemistry (float), Average (float).
